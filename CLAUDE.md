...
**Dedicated QA Project:** [saas202510 - QA/Testing Infrastructure](C:/devop/saas202510)
**Purpose:** Zero-tolerance testing for financial accuracy

**IMPORTANT: Build with Testing in Mind**

When developing features in this project, remember:
- ✅ A dedicated QA project (saas202510) will test everything you build
- ✅ Build features with testability as a first-class requirement
- ✅ Follow test-driven development practices
- ✅ Document testing considerations in technical specs
- ✅ After implementing features, remind user: "Tests should be added in saas202510"

**Testing Requirements for This Project:**
- All financial calculations must be deterministic and testable
- Business logic should be pure functions where possible
- API endpoints must have clear contracts for integration testing
- Database schemas must support test data generation
- Event sourcing enables time-travel testing and debugging

**When to Reference saas202510:**
- After implementing new financial features: "Ready to add tests in saas202510"
- When making architecture decisions: "This design makes testing easier in saas202510"
- During bug fixes: "Regression test should be added in saas202510"
- For complex accounting logic: "Property-based tests in saas202510 will validate invariants"

**Ports Coordination:**
- saas202509 (this project): Frontend 3009, Backend 8009, DB 5409
- saas202510 (test project): Frontend 3010, Backend 8010, DB 5410
- Test environment can connect to dev environment for integration testing
...
**Tell user:** "✅ Documentation saved and pushed to GitHub at https://github.com/ChrisStephens1971/saas202509"
